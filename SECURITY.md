...
The checkout pins preview AGP `9.0.0-alpha06`. No security or release claim should be based on that pin until dependencies are resolved, the complete Gradle matrix passes, and release artifacts are dependency-scanned.
