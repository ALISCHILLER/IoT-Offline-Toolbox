# Deep code and configuration audit — 3.6.0


> **Historical document — not current configuration.** This file records the 3.6.0 audit state and includes a historical Gradle 9.6.1 statement. The current 3.6.2 checkout uses Gradle 9.1.0 and preview AGP 9.0.0-alpha06. Current findings and status are in [`DEEP_AUDIT_REVISION_2026-07-20.md`](DEEP_AUDIT_REVISION_2026-07-20.md).
...
|---|---|---|
| Gradle wrapper | 9.6.1 HTTPS distribution with pinned SHA-256 and timeout | Verified statically |
...
| Version | 3.6.0 / build 36 across central properties, Android, iOS, Desktop, About/backup | Verified statically |
