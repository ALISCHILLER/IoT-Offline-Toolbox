...
for file in DnsSdCodec.kt SsdpParser.kt; do
...
for file in NetworkInputPolicy.kt HttpResponseBodyTools.kt; do
  cp "$ROOT/composeApp/src/commonMain/kotlin/com/msa/iotofflinetoolbox/core/policy/$file" \
    "$WORK/com/msa/iotofflinetoolbox/core/policy/$file"
done
