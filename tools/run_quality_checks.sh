...
run_audit() {
  ...
  python3 tools/kmp_contract_audit.py
...
run_runtime_harnesses() {
  ...
  bash tools/application_architecture_runtime_harness.sh
  bash tools/store_facade_compile_harness.sh
  bash tools/repository_compile_harness.sh
  bash tools/browser_network_runtime_harness.sh
  bash tools/protocol_runtime_harness.sh
  bash tools/protocol_fuzz_runtime_harness.sh
