...
rm -rf "$WORK"
mkdir -p "$WORK/com/msa/iotofflinetoolbox/core/model" "$WORK/com/msa/iotofflinetoolbox/core/network" "$WORK/com/msa/iotofflinetoolbox/core/policy" "$WORK/com/msa/iotofflinetoolbox/core/security" "$WORK/com/msa/iotofflinetoolbox/core/payload"

cp "$ROOT/composeApp/src/commonMain/kotlin/com/msa/iotofflinetoolbox/core/policy/TransportSecurity.kt" "$WORK/com/msa/iotofflinetoolbox/core/policy/"
cp "$ROOT/composeApp/src/commonMain/kotlin/com/msa/iotofflinetoolbox/core/policy/HeaderParser.kt" "$WORK/com/msa/iotofflinetoolbox/core/policy/"
cp "$ROOT/composeApp/src/commonMain/kotlin/com/msa/iotofflinetoolbox/core/policy/NetworkInputPolicy.kt" "$WORK/com/msa/iotofflinetoolbox/core/policy/"
cp "$ROOT/composeApp/src/commonMain/kotlin/com/msa/iotofflinetoolbox/core/policy/ProtocolRuntimePolicy.kt" "$WORK/com/msa/iotofflinetoolbox/core/policy/"
cp "$ROOT/composeApp/src/commonMain/kotlin/com/msa/iotofflinetoolbox/core/policy/HttpResponseBodyTools.kt" "$WORK/com/msa/iotofflinetoolbox/core/policy/"
cp "$ROOT/composeApp/src/commonMain/kotlin/com/msa/iotofflinetoolbox/core/security/SecretRedactor.kt" "$WORK/com/msa/iotofflinetoolbox/core/security/"
...
import com.msa.iotofflinetoolbox.core.policy.calculateHttpTimeoutBudget
...
fun main() {
    ...
    checkValue(!mqttRequiresReceiveLoop("", "", publishQos = 0), "MQTT connection-only completion")
    checkValue(!mqttRequiresReceiveLoop("", "sensors/value", publishQos = 0), "MQTT QoS 0 publish-only completion")
    checkValue(mqttRequiresReceiveLoop("", "sensors/value", publishQos = 1), "MQTT QoS 1 PUBACK wait")
    checkValue(mqttRequiresReceiveLoop("sensors/#", "", publishQos = 0), "MQTT subscription receive loop")
