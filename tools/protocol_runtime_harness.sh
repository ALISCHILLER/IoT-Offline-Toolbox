...
rm -rf "$WORK"
mkdir -p "$WORK/com/msa/iotofflinetoolbox/core/network" "$WORK/com/msa/iotofflinetoolbox/core/model" "$WORK/com/msa/iotofflinetoolbox/core/payload"
...
cp "$ROOT/composeApp/src/commonMain/kotlin/com/msa/iotofflinetoolbox/core/network/HttpResponseBodyTools.kt" \
  "$WORK/com/msa/iotofflinetoolbox/core/network/HttpResponseBodyTools.kt"
